...
The methodology serves as a practical framework for developing, documenting, and maintaining systems that incorporate AI agents directly within the development environment.
...
- English templates — [`/methodology-templates/en`](./methodology-templates/en)  
- Hebrew templates — [`/methodology-templates/he`](./methodology-templates/he)

> All templates are written in Markdown format and can be directly integrated into any IDE or existing development project.
...
The methodology establishes a new language of collaboration between **humans and agents** — a language where documentation is not an afterthought but a living, meaningful interface.  
Every update to the system changes the documentation, and every update to the documentation affects the system — in real time and with full transparency.
...
The developer defines the “what” through living documentation, and the agent performs the “how” directly within the environment.  
Each commit becomes an accurate reflection of documented understanding.

---

## 📘 Further Reading

Want to understand how the methodology was born and what inspired it?  
Read about the concept, vision, and philosophy on the About page:  
<a href="./md.html?src=ABOUT.en.md">About 👉</a>
